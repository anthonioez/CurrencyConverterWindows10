...
namespace CurrencyConverter
{
    ...
    sealed partial class App : Application
    {
        ...
        public static Currency slotFr = new Currency();
        public static Currency slotTo = new Currency();

        public static ObservableCollection<Currency> currencies = new ObservableCollection<Currency>();
        public static ObservableCollection<Currency> favorites  = new ObservableCollection<Currency>();

        public static DataModel dataModel = null;
        public static string name = "Currency Converter";
